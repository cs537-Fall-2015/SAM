...
public class samTestMain {
	public static void main(String[] args) {
		...
		try {
			...
			Thread sam_server = RoverThreadHandler.getRoverThreadHandler().getNewThread(serverOne);
			...
			Thread sam_client = RoverThreadHandler.getRoverThreadHandler().getNewThread(clientOne);
